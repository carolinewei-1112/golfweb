    ...
    <div className="animate-fade-in space-y-5 sm:space-y-7">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl p-5 sm:p-7" style={{
        ...
        <div className="relative">
          ...
          <p className="text-xs sm:text-sm text-white/70 mt-1.5">百鸟会高尔夫巡回赛规则及奖励机制</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden card-shadow" style={{ background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(8px)' }}>
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-gray-100" style={{ background: 'linear-gradient(135deg, rgba(255, 251, 235, 0.9) 0%, rgba(255, 255, 255, 0.9) 100%)' }}>
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          <div className="rounded-xl sm:rounded-2xl p-4 sm:p-5" style={{
            background: 'linear-gradient(135deg, rgba(254, 249, 195, 0.4) 0%, rgba(254, 240, 138, 0.3) 100%)',
            ...
            <div className="grid grid-cols-3 gap-2.5 sm:gap-4">
              {[
                ...
                <div key={prize.place} className="rounded-xl sm:rounded-2xl p-2.5 sm:p-4 text-center card-shadow" style={{ background: 'rgba(255, 255, 255, 0.9)' }}>
                  ...
                  <div className="text-base sm:text-xl font-bold mt-1" style={{ background: `linear-gradient(135deg, var(--tw-gradient-stops))`, WebkitBackgroundClip: 'text' }}>
                    <span className="text-amber-600">{prize.amount}</span>
                  </div>
                </div>
              ))}
            </div>
            <p className="text-[10px] sm:text-xs text-gray-500 mt-3 sm:mt-4 text-center bg-white/60 py-1.5 rounded-full">
              由月赛后三名为前三名颁奖 🎁
            </p>
          </div>
          ...
          {/* 打鸟奖励 */}
          <div className="rounded-xl sm:rounded-2xl p-4 sm:p-5" style={{
            background: 'linear-gradient(135deg, rgba(220, 252, 231, 0.4) 0%, rgba(187, 247, 208, 0.3) 100%)',
      ...
      {/* 百鸟会算分规则 */}
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden card-shadow" style={{ background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(8px)' }}>
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-gray-100" style={{ background: 'linear-gradient(135deg, rgba(240, 250, 244, 0.9) 0%, rgba(255, 255, 255, 0.9) 100%)' }}>
          <h2 className="text-sm sm:text-base font-bold text-gray-800 flex items-center gap-2.5">
        ...
        <div className="p-4 sm:p-6 space-y-5 sm:space-y-6 text-xs sm:text-sm text-gray-600">
          {[
            ...
            },
            {
              ...
              title: '进步系数计算',
              items: [
                <span key="formula">公式：<span className="bg-golf-50 text-golf-700 px-2 py-0.5 rounded-lg text-[10px] sm:text-xs font-medium">(历史6场平均成绩 - 本场成绩) × 进步因子</span></span>,
                '进步系数为正数表示进步，负数表示退步',
                '进步系数数值越大，表示进步越明显',
              ],
            },
            ...
            <div key={section.num}>
              <h3 className="font-semibold text-gray-800 mb-2.5 flex items-center gap-2.5">
                <span className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg flex items-center justify-center text-[10px] sm:text-xs font-bold text-white" style={{ background: 'linear-gradient(135deg, #166e3a 0%, #22a85a 100%)' }}>{section.num}</span>
                {section.title}
              </h3>
      ...
      {/* 违规与罚杆速查表 */}
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden card-shadow" style={{ background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(8px)' }}>
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-gray-100" style={{ background: 'linear-gradient(135deg, rgba(254, 242, 242, 0.9) 0%, rgba(255, 255, 255, 0.9) 100%)' }}>
          <h2 className="text-sm sm:text-base font-bold text-gray-800 flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm" style={{ background: 'rgba(239, 68, 68, 0.1)' }}>⚠️</div>
            违规与罚杆速查表
          </h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            <thead>
              <tr style={{ background: 'rgba(249, 250, 251, 0.8)' }} className="text-gray-500">
            ...
            <tbody className="text-gray-600">
              ...
              <tr className="border-b border-gray-50">
                <td className="px-3 sm:px-4 py-2 sm:py-3 align-top" rowSpan={6}>
                  <span className="inline-flex items-center justify-center px-2 sm:px-2.5 h-5 sm:h-6 rounded-lg text-[10px] sm:text-xs font-bold" style={{ background: 'rgba(234, 179, 8, 0.12)', color: '#a16207' }}>罚1杆</span>
                </td>
              ...
              <tr className="border-b border-gray-50">
                <td className="px-3 sm:px-4 py-2 sm:py-3 align-top" rowSpan={4}>
                  <span className="inline-flex items-center justify-center px-2 sm:px-2.5 h-5 sm:h-6 rounded-lg text-[10px] sm:text-xs font-bold" style={{ background: 'rgba(239, 68, 68, 0.1)', color: '#b91c1c' }}>罚2杆</span>
                </td>
      ...
      {/* 百鸟会入会会费 */}
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden card-shadow" style={{ background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(8px)' }}>
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-gray-100" style={{ background: 'linear-gradient(135deg, rgba(245, 243, 255, 0.9) 0%, rgba(255, 255, 255, 0.9) 100%)' }}>
          <h2 className="text-sm sm:text-base font-bold text-gray-800 flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm" style={{ background: 'rgba(139, 92, 246, 0.1)' }}>👥</div>
            会费说明
          </h2>
        </div>
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-5 text-xs sm:text-sm text-gray-600">
          <div className="rounded-xl sm:rounded-2xl p-3 sm:p-4" style={{ background: 'linear-gradient(135deg, rgba(245, 243, 255, 0.5) 0%, rgba(237, 233, 254, 0.4) 100%)', border: '1px solid rgba(139, 92, 246, 0.1)' }}>
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-100/80">
            ...
            <span className="text-xs sm:text-sm text-gray-600 bg-gray-50 px-3 py-1 rounded-full">12个月</span>
          </div>
      ...
      <div className="rounded-2xl sm:rounded-3xl p-4 sm:p-6 card-shadow" style={{
        background: 'linear-gradient(135deg, rgba(240, 250, 244, 0.95) 0%, rgba(220, 252, 231, 0.95) 100%)',
